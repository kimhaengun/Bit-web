	...
	<form action="bbs/update.jsp">
		<table width="400" align="center">
			<tr>
				<td>empno</td>
				<td>
					<input type="text" name="empno" value="<%=bean.getEmpno()%>" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td>ename</td>
				<td>
					<input type="text" name="ename" value="<%=bean.getEname()%>" <%=bean.isRead()?"readonly":""%>>
				</td>
			</tr>
			<tr>
				<td>job</td>
				<td>
					<input type="text" name="job" value="<%=bean.getJob()%>" <%=bean.isRead()?"readonly":""%>>
				</td>
			</tr>
			<tr>
				<td>mgr</td>
			...
			<tr>
				<td>sal</td>
				<td>
					<input type="text" name="sal" value="<%=bean.getSal()%>" <%=bean.isRead()?"readonly":""%>>
				</td>
			</tr>
			<tr>
				<td>comm</td>
				<td>
					<input type="text" name="comm" value="<%=bean.getComm()%>" <%=bean.isRead()?"readonly":""%>>
				</td>
			</tr>
			<tr>
				<td>deptno</td>
				<td>
					<input type="text" name="deptno" value="<%=bean.getDeptno()%>" <%=bean.isRead()?"readonly":""%>>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					...
					%>
					<a href="./?title=bbs/detail&read=false&empno=<%=bean.getEmpno() %>">수정</a>
