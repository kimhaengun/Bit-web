...
//		webSocketHandler.handleMessage(null, new TextMessage("출력"));
//		for(WebSocketSession wss : ((EchoHandler)webSocketHandler).getList()) {
//			wss.sendMessage(new TextMessage("서버에서 전달"));
//		}
	...
	public String ex02(HttpSession session) throws IOException {
		System.out.println("ex02 Contoller : "+session.getId());
