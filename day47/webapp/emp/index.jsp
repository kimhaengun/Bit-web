		...
		<div id="content">
				...
				<table>
					...
					<tbody>
						...
						%>
							<tr>
								<td><a href="detail.do?idx=<%=bean.getEmpno()%>"><%=bean.getEmpno() %></a>
								<td><a href="detail.do?idx=<%=bean.getEmpno()%>"><%=bean.getEname() %></a>
								<td><a href="detail.do?idx=<%=bean.getEmpno()%>"><%=bean.getHiredate() %></a>
								<td><a href="detail.do?idx=<%=bean.getEmpno()%>"><%=bean.getSal() %></a>
							</tr>
						<%	} %>
					</tbody>
				</table>
