...
<body>
	...
	<%
		...
		try{
			...
			stmt.executeUpdate("insert into emp (empno, ename, hiredate, sal, comm, deptno) values ("
				...
				");");
			out.print("<h1 align=\"center\">입력 성공</h1>");
			out.print("<p align=\"center\"><a href=\"index.jsp\">이동</a></p>");
		}finally{
