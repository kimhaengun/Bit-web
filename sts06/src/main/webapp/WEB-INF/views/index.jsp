  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="${pageContext.servletContext.contextPath }/">Home <span class="sr-only">(current)</span></a></li>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="https://picsum.photos/id/237/1200/500" alt="237" class="img-thumbnail">
    </div>
    <div class="item">
      <img src="https://picsum.photos/id/238/1200/500" alt="238" class="img-thumbnail">
    </div>
    <div class="item">
      <img src="https://picsum.photos/id/239/1200/500" alt="239" class="img-thumbnail">
    </div>
  </div>
