...
<body>
	...
	<table width="500" align="center">
		<tr>
			...
			<td colspan="3">
				<input type="text" name="sub" value="<jsp:getProperty property="sub" name="bean"/>">
			</td>
		</tr>
		<tr align="center">
			<td width="100">글쓴이</td>
			...
			<td width="100">조회수</td>
			<td width="100">
				<jsp:getProperty property="cnt" name="bean"/>
			</td>
		</tr>
		<tr align="center">
			<td colspan="4"><textarea cols="70" rows="5" name="content" >
